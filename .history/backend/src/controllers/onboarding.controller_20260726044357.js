...
const submit = asyncHandler(async (req, res) => {
  ...
  await createNotification({
    recipientRole: 'HR', title: 'New Onboarding Submission',
    message: 'An employee submitted their onboarding form for review.', link: '/app/onboarding-review'
  });
...
const review = asyncHandler(async (req, res) => {
  ...
  if ((decision === 'Rejected' || decision === 'ChangesRequested') && (!note || !note.trim())) {
    throw new ApiError(400, 'Please add a remark explaining why.');
  }
