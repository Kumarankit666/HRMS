...
// Safety net: log unexpected async errors instead of letting them crash the whole process.
...
app.use('/files/leadership', express.static(require('path').join(__dirname, '..', 'storage', 'leadership')));
app.use('/files/toppers', express.static(require('path').join(__dirname, '..', 'storage', 'toppers')));
...
app.use('/api/toppers', require('./routes/toppers.routes'));
app.use('/api/toppers-admin', require('./routes/toppersAdmin.routes'));
app.use('/api/notifications', require('./routes/notifications.routes'));
app.use('/api/jobs', require('./routes/jobs.routes'));
app.use('/api/jobs-admin', require('./routes/jobsAdmin.routes'));
app.use('/api/contact', require('./routes/contact.routes'));
app.use('/api/leadership', require('./routes/leadership.routes'));
app.use('/api/leadership-admin', require('./routes/leadershipAdmin.routes'));
