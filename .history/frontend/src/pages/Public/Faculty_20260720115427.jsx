const FACULTY = [
  { name: 'Dr. G S Roy', role: 'Chairman & Founding Faculty', subject: 'Leadership & Strategy', initials: 'GR' },
  { name: 'Prateek Kumar', role: 'Director', subject: 'Academic Operations', initials: 'PK' },
  { name: 'Faculty Member', role: 'Senior Faculty', subject: 'Mathematics', initials: 'FM' },
