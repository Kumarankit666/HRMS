...
export default function Home() {
  return (
    <div>
      ...
      <div className="dev-credit" style={{ padding: '18px 0', color: '#8f8ba8' }}>
        Developed &amp; Managed by <a href="https://www.kumarankit.in/" target="_blank" rel="noreferrer" style={{ color: 'var(--primary)' }}>Ankit Kumar</a>
      </div>
    </div>
  );
}