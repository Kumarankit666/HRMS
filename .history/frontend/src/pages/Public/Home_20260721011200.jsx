...
export default function Home() {
  return (
    <div>
      ...
      <div className="dev-credit" style={{ padding: '20px 0', textAlign: 'center', color: '#6b7280', fontSize: '0.85rem', borderTop: '1px solid var(--border)' }}>
        Developed &amp; Managed by <a href="https://www.kumarankit.in/" target="_blank" rel="noreferrer" style={{ color: 'var(--primary)', fontWeight: 700 }}>Ankit Kumar</a>
      </div>
    </div>
  );
}