    ...
    <Modal title={existing ? 'Edit Faculty Member' : 'Add Faculty Member'} onClose={onClose} footer={
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="grid-2">
          ...
          <div className="field"><label>Years of Experience</label><input value={experienceYears} onChange={(e) => setExperienceYears(e.target.value)} placeholder="e.g. 10+ years" /></div>
        </div>
